...
{{< step-card num="1" icon="🎟️" title="Achetez votre billet" >}}
...
{{< step-card num="2" icon="🎯" title="Participez au tirage du mardi" >}}
...
{{< step-card num="3" icon="⏰" title="Répondez rapidement" warning="true" >}}
...
Tant que le Joker n'est pas trouvé, le gros lot continue de s'accumuler. Chaque carte retirée réduit les possibilités restantes — plus vous jouez régulièrement, **plus vos chances augmentent** !
{{< /step-card >}}
...
*Revenu des ventes hebdomadaires, ***après déduction de 12 % de frais administratifs*** :*

{{< spacer 10 >}}

{{< prize-grid >}}
{{< prize-card percent="30 %" label="Billet gagnant" desc="Remis au détenteur du billet tiré au sort" >}}
{{< prize-card percent="25 %" label="Gros lot du Joker" desc="Cagnotte accumulée jusqu'à ce qu'on trouve le Joker" jackpot=true >}}
{{< prize-card percent="45 %" label="Comité des Loisirs" desc="Soutient les activités de votre communauté" >}}
{{< /prize-grid >}}

{{< spacer 30 >}}

{{% callout type="info" %}}
Tentez votre chance, soutenez votre communauté et vivez l'excitation de la chasse au Joker ! 🍀
{{% /callout %}}
