...
Salle communautaire de Fatima (Entrée côté de l'église)
...
**Mardis à 19 h 30**  
Portes ouvertes dès **18 h 30**.

*Annulations et bingos spéciaux annoncés sur Facebook.*
{{< /card >}}
...
**18 ans requis** — aucun mineur admis lors des soirées bingo.
{{< /card >}}
...
Le **livret standard (7 feuilles)** est requis pour entrer. Sans livret, l'entrée est refusée.
{{< /card >}}
{{< /cards >}}
...
- Tirages au **boulier électronique** — numéros affichés sur les écrans.
- **Attendez l'annonce de l'animatrice avant de réagir.**
- Si vous gagnez, criez **« BINGO »** — un membre du personnel viendra vérifier.- Respectez les consignes du personnel et de l'animateur·trice.
- Les décisions de l'organisateur sont finales.
- Tout comportement inapproprié peut entraîner le retrait de l'accès.{{< /card >}}

{{< card >}}
<span class="card-icon">🎨</span>

#### Les feuilles & couleurs
