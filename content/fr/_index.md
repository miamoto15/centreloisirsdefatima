...
Le Centre des loisirs de Fatima est idéalement situé dans un environnement naturel et apaisant, qui permet aux visiteurs de profiter d'une vue magnifique sur les paysages environnants tout en participant à des activités physiques ou récréatives, ou simplement pour un moment de détente. Il est un excellent point de départ pour explorer les beautés naturelles de l'île et des environs.
